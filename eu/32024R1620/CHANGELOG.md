<!-- emendrix:changelog b7f4a1c2-9e3d eu:32024R1620 -->
# eu:32024R1620 — changelog
...
Amendments to `eu:32024R1620`, newest first, computed by emendrix from the corpus's own published versions.
...
<!-- emendrix:entry b7f4a1c2-9e3d 02024R1620-20251110 -->
...
- **Citations** `v1` = `32024R1620` · `v2` = `02024R1620-20251110`

---

**MODIFIED · Art. 5 — Tasks** · applies from: unchanged
...
> (g) support, facilitate and strengthen cooperation and exchange of information between obliged entities and supervisors, supervisory authorities and non-AML/CFT authorities in order to develop a comm […truncated by emendrix: 7806 characters omitted…]
...
> (e) analyse the information collected in the central database and share those analyses with supervisors, supervisory authorities and non-AML/CFT authorities on a need-to-know and confidential basis;
> (f) support the analysis of risks of ML/TF and of non-implementation and evasion of targeted financial sanctions affecting the internal market, referred to in Article 7 of Directive (EU) 2024/1640;
> (g) support, facilitate and strengthen cooperation and exchange of information between obliged entities and supervisors, supervisory authorities and non-AML/CFT authorities in order to develop a comm […truncated by emendrix: 8359 characters omitted…]

**MODIFIED · Art. 55 — Opinions and technical advice** · applies from: unchanged
...
**MODIFIED · Art. 88 — Obligation of professional secrecy** · applies from: unchanged
