<!-- emendrix:changelog b7f4a1c2-9e3d eu:32016R0426 -->
# eu:32016R0426 — changelog
...
Amendments to `eu:32016R0426`, newest first, computed by emendrix from the corpus's own published versions.
...
<!-- emendrix:entry b7f4a1c2-9e3d 02016R0426-20260529 -->
## Regulation (EU) 2016/426 of the European Parliament and of the Council of 9 March 2016 on appliances burning gaseous […]
### `32016R0426` → `02016R0426-20260529`

- **Act** `eu:32016R0426` · **In force** 2026-05-29 · **Detected** 2026-09-04
- **Touched** 7 provisions — 6 substantive · 0 date-only · 1 with no text · **6 disputed**
- **Diff** 6 inserted · 1 modified · 0 deleted · 0 renumbered · 0 deferred · 51 unchanged
- **Gate** 0 sentences quoted verbatim · 1 changes shipped without an explanation
- **Citations** `v1` = `32016R0426` · `v2` = `02016R0426-20260529`
...
*within* `AR 2 ALN 1 PO 31`, `AR 2 ALN 1 PO 32`, `AR 2 ALN 1 PO 33` · *dates* +2024-10-09 · *amended by* `32024R2748`

The list of definitions gains two new entries: point (32) defining crisis-relevant goods by reference to Article 3, point (6), of Regulation (EU) 2024/2747, and point (33) defining internal market emergency mode by reference to Article 3, point (3), of the same Regulation. [Art. 2, v2](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:02016R0426-20260529#art_2)

The prior version ended its list of definitions at point (31), the CE marking definition, without any reference to crisis-relevant goods or internal market emergency mode. [Art. 2, v1](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:32016R0426#art_2)
...
> (5) cooking means the art or practice of preparing or warming food for consumption with the use of heat and employing a wide range of methods;
...
> (9) gas family means a group of gaseous fuels with similar burning behaviour linked together by a range of Wobbe indices;
> (10) g […truncated by emendrix: 3446 characters omitted…]

*after* (`02016R0426-20260529`)
...
**INSERTED · Art. 40b — Prioritisation of the conformity assessment of appliances and fittings designated as crisis-relevant goods** · applies from: unknown (an inserted provision states its own application date only in prose)

*amended by* `32024R2748`

**DISPUTED** — seen by the structural diff, the instruction parse, not by corpus metadata

This new provision sets out that notified bodies must give priority processing to conformity assessment applications for appliances and fittings designated as crisis-relevant goods, regardless of when those applications were lodged relative to activation of the emergency procedures. [Art. 40b, v2](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:02016R0426-20260529#art_40b)

It further states that this prioritisation must not cause additional disproportionate costs for manufacturers, and that notified bodies must make reasonable efforts to increase their testing capacities for the affected appliances and fittings. [Art. 40b, v2](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:02016R0426-20260529#art_40b)
...
**INSERTED · Art. 40c — Derogation from the conformity assessment procedures requiring the mandatory involvement of a notified body** · applies from: unknown (an inserted provision states its own application date only in prose)

*amended by* `32024R2748`

**DISPUTED** — seen by the structural diff, the instruction parse, not by corpus metadata

This is a new provision setting out a derogation procedure allowing a Member State to authorise placing on the market or use of a specific appliance or fitting without the notified-body conformity assessment otherwise required, subject to conditions, Commission review, and eventual extension of validity across the Union. [Art. 40c, v2](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:02016R0426-20260529#art_40c)

It also specifies obligations on manufacturers, content requirements for any such authorisation, marking rules excluding CE marking, and market surveillance powers tied to authorisations granted under this article. [Art. 40c, v2](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:02016R0426-20260529#art_40c)
...
> 2. The implementing acts referred to in paragraph 1 shall set out the most appropriate alternative technical solution for the purposes of providing a presumption of conformity in accordance with paragraph 5. To […truncated by emendrix: 3065 characters omitted…]

**INSERTED · Art. 40e — Prioritisation of market surveillance activities and mutual assistance among authorities** · applies from: unknown (an inserted provision states its own application date only in prose)

*amended by* `32024R2748`

**DISPUTED** — seen by the structural diff, the instruction parse, not by corpus metadata

A new Article 40e has been added, requiring Member States to prioritise market surveillance activities for appliances and fittings listed in the implementing act referred to in Article 40a(1), with the Commission facilitating coordination of that prioritisation through the Union Product Compliance Network under Regulation (EU) 2019/1020. [Art. 40e, v2](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:02016R0426-20260529#art_40e)

It also has market surveillance authorities of the Member States making best efforts to assist other such authorities during an internal market emergency mode, including through mobilising and dispatching expert teams or providing logistical support such as reinforced testing capacity for the same listed appliances and fittings. [Art. 40e, v2](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:02016R0426-20260529#art_40e)
...
<!-- emendrix:entry-end b7f4a1c2-9e3d 02016R0426-20260529 -->
